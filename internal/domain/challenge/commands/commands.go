...
func NewCreateChallengeCommand(id int64, name *string, icon *string, description *string, interests *string,
...
func NewUpdateChallengeCommand(id int64, challengeID int64, name *string, icon *string, image *string, description *string, interests *string,
